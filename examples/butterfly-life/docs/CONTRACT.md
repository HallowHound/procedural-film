...
A film of the life of a monarch butterfly, drawn entirely by JavaScript on a canvas, with music and sound effects synthesised in JavaScript.
It ships as one self-contained HTML file and as a rendered MP4 for YouTube Shorts.
The look and editing follow `docs/reference-analysis.md`.
...
Playwright installs into `tools/node_modules` (`npm install` there first).
